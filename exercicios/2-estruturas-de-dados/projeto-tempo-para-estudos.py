...
print(f"{nome}, voce costuma estudar {total_horas} horas por dia, 
{total_dias} dias por semana. 
Isso significa que voce estuda {curso}, 
em media, {total_dias*total_horas} horas por semana")
