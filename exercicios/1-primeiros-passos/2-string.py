...
resumo = "Paloma e uma mulher de 46 anos que deseja mudar de profissao estudando 'python'"
print(resumo)
...
idade = 46
print(f"Paola e uma mulher de {idade} anos que deseja mudar de profissao estudando 'python'")
